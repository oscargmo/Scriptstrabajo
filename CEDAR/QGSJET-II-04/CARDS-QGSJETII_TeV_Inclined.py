...
ejecutable = "./corsika77100Linux_QGSII_fluka < "
...
for i in range(len(run_num)):
    ...
    file.write("QGSJET  T   0                         QGSJET for high energy & debug level" + os.linesep)
    file.write("QGSSIG  T   0                         QGSJET cross-sections enabled" + os.linesep)
...
for i in range(len(run_num)):
    ...
    file.write("#SBATCH --output=csk2root-%J.out" + os.linesep)
    file.write("#SBATCH " + time_csk2root + os.linesep)
    file.write("#SBATCH --ntasks=1" + os.linesep)
    file.write("#SBATCH --mem-per-cpu=32G" + os.linesep)
    file.write(""  + os.linesep)
