...
ejecutable = "./corsika77100Linux_EPOS_fluka < "
...
for i in range(len(run_num)):
    ...
    file.write("EPOS    T  0 " + os.linesep)
    file.write("EPOSIG  T       " + os.linesep)
    file.write("EPOPAR input ../epos/epos.param        !initialization input file for epos" + os.linesep)
    file.write("EPOPAR fname inics ../epos/epos.inics  !initialization input file for epos" + os.linesep)
    file.write("EPOPAR fname iniev ../epos/epos.iniev  !initialization input file for epos" + os.linesep)
    file.write("EPOPAR fname initl ../epos/epos.initl  !initialization input file for epos" + os.linesep)
    file.write("EPOPAR fname inirj ../epos/epos.inirj  !initialization input file for epos" + os.linesep)
    file.write("EPOPAR fname inihy ../epos/epos.ini1b  !initialization input file for epos" + os.linesep)
    file.write("EPOPAR fname check none                !dummy output file for epos" + os.linesep)
    file.write("EPOPAR fname histo none                !dummy output file for epos" + os.linesep)
    file.write("EPOPAR fname data  none                !dummy output file for epos" + os.linesep)
    file.write("EPOPAR fname copy  none                !dummy output file for epos" + os.linesep)
...
for i in range(len(run_num)):
    ...
    file.write("#SBATCH --output=csk2root" + str(i+1).zfill(3) + "-%J.out" + os.linesep)
    file.write("#SBATCH " + time_csk2root + os.linesep)
    file.write("#SBATCH --ntasks=1" + os.linesep)
    file.write("#SBATCH --mem-per-cpu=8G" + os.linesep)
    file.write(""  + os.linesep)
    file.write("module load root" + os.linesep)
    file.write("export COAST_DIR=/home/oscargmo/MathuslaCR/Coast/coast-v4r5" + os.linesep)
